				...
				hideChat(0);
					...
					<script type="text/javascript">
						...
						$(document).on('click','.sendcontact', function(event){
							...
							if($('#name').val() == ''){
								$('#name').after('<em class="error" style="color:red">Please enter your Name</em>')
								return false
							}


							if($('#phone').val() == ''){
								$('#phone').after('<em class="error" style="color:red">Please enter your Phone</em>')
								return false
							}
							...
							console.log(n);
							if(n<9){
								$('#phone').after('<em class="error" style="color:red">Please check your Phone</em>')
								return false
							}

							if($('#email').val() == ''){
								$('#email').after('<em class="error" style="color:red">Please check your email</em>')
								return false
							}


							if(!validateEmail($('#email').val())){
								$('#email').after('<em class="error" style="color:red">Please enter your email</em>')
								return false
							}
					...
					</html><?php /**PATH C:\Users\Cloudelabs-1\Downloads\Telegram Desktop\mkchat\resources\views/base.blade.php ENDPATH**/ ?>